...
James Brown: I prefer 66 for better readability
...
(defun ome-flycheck-setup ()
  (eval-after-load 'flycheck
    '(progn
       (setq flycheck-checkers (delq 'emacs-lisp-checkdoc
                                     flycheck-checkers))

       (define-key flycheck-mode-map "\C-c!k" 'kill-flycheck)))

  (add-hook 'prog-mode-hook 'flycheck-mode))

(defun kill-flycheck ()
  (interactive)
  (delete-process "flycheck"))
